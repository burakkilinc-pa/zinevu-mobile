...
struct Copy {
    ...
    let saving: String
    let resultArea: String      // "%@ m² veranda"
    /**
    ...
    static let dutch = Copy(
        ...
        hintThird: "Zet een punt aan de buitenrand van je veranda",
        hintReady: "Klaar om op te slaan — of zet nog een punt",
        introTitle: "Meet je veranda",
    ...
    static let english = Copy(
        ...
        hintThird: "Place a point at the outer edge of your veranda",
        hintReady: "Ready to save — or place another point",
        introTitle: "Measure your veranda",
    ...
    static let german = Copy(
        ...
        hintThird: "Setzen Sie einen Punkt an die Außenkante Ihrer Veranda",
        hintReady: "Bereit zum Speichern — oder setzen Sie einen weiteren Punkt",
        introTitle: "Messen Sie Ihre Veranda",
        ...
        viewInGarden: "Ihre Veranda im Garten ansehen",
        preparingModel: "Ihre Veranda wird vorbereitet…",
        standItHere: "Veranda hier aufstellen",
    ...
    static let french = Copy(
        ...
        hintThird: "Placez un point sur le bord extérieur de votre véranda",
        hintReady: "Prêt à enregistrer — ou placez un autre point",
        introTitle: "Mesurez votre véranda",
        ...
        viewInGarden: "Voir votre véranda dans votre jardin",
        preparingModel: "Votre véranda est en préparation…",
        standItHere: "Placer votre véranda ici",
    ...
    static let turkish = Copy(
        ...
        hintThird: "Verandanın dış kenarına bir nokta koy",
        hintReady: "Kaydetmeye hazır — ya da bir nokta daha koy",
        introTitle: "Verandanı ölç",
